...
namespace ManagerVM.Services.Migrations
{
    ...
    [Migration("20240806080840_AddColumnHostStatus")]
    partial class AddColumnHostStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ManagerVM.Data.Entities.VMEntity", b =>
                {
                    ...
                    b.Property<int>("HostStatus")
                        .HasColumnType("int");

                    b.Property<bool>("InstallAllServiceSuccess")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("VMEntities", "ManagerVM");
                });
